...
(function($opal) {
  ...
  $opal.add_stubs(['$extend', '$new', '$attr_accessor', '$def_delegators', '$+', '$*', '$-', '$size', '$name', '$class', '$to_s', '$each_with_index', '$define_method', '$[]', '$[]=', '$sqrt', '$**', '$/', '$length', '$==', '$components', '$-@', '$x', '$y', '$z', '$atan2', '$cos', '$sin', '$unit', '$add!']);
  ;
  (function($base) {
    var self = $module($base, 'Yeah');
...
if (v == null) v = nil;
      ...
      def.$along = function(angle, distance) {
        ...
        return self.$class().$new(self.components['$[]'](0)['$+']((($a = $scope.Math) == null ? $opal.cm('Math') : $a).$cos(angle)['$*'](distance)), self.components['$[]'](1)['$+']((($a = $scope.Math) == null ? $opal.cm('Math') : $a).$sin(angle)['$*'](distance)), self.components['$[]'](2));
      };
...
if (e == null) e = nil;
      ...
      return (def.$defaults = function() {
        ...
        ticker = (($a = $scope.Ticker) == null ? $opal.cm('Ticker') : $a).$new();
        return $hash2(["ticker", "display", "keyboard", "mouse"], {"ticker": ticker, "display": (($a = $scope.Display) == null ? $opal.cm('Display') : $a).$new(), "keyboard": (($a = $scope.Keyboard) == null ? $opal.cm('Keyboard') : $a).$new($hash2(["ticker"], {"ticker": ticker})), "mouse": (($a = $scope.Mouse) == null ? $opal.cm('Mouse') : $a).$new($hash2(["ticker"], {"ticker": ticker}))});
      }, nil) && 'defaults';
    })(self, null)
